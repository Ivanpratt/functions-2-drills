...
const actuallyMultiply = function(a, b) {
  return a * b
}

const multiply = function(number1, number2, callback){
  return callback(number1, number2)
}

console.log(multiply(12, 12, actuallyMultiply))
...
// const math = function(num1, num2, callback){
//     add(num1, num2)

// }


// console.log(math(11, 11, add()))
//console.log(math(11, 12, add))
...
*/
let firstName = function(arrayVariable){
  return arrayVariable[0]

}


let first = function(arrayName, callback) {
    return callback(arrayName)
...
let lastName = function(arrayVariable){
  return arrayVariable[arrayVariable.length -1]

}

console.log(first(names, lastName))
...
*/
let nameChecked = function(personsName, outcome){
  
  if (outcome === false) {
  return `the name ${personsName} does Not exist in the array.`
  } else if (outcome === true) {
    return `the name ${personsName} Does exist in the array.`
  }

}


let contains = function(arrayName, personsName, callback) {
  outcome = arrayName.includes(personsName)
  return callback(personsName, outcome)
}

console.log(contains(names, "Ryan", nameChecked))
